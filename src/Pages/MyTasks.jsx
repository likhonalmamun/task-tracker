...
const MyTasks = () => {
  ...
  return (
    <div>
      <div className="p-10 border-2 border-blue-500 rounded-md">
        ...
        <div>
          {tasks.map((task) => (
            ...
            >
              <div>
                <h1 className="text-center font-bold text-rose-600 mb-3">{task.title}</h1>
                <Link
              ...
              <div className="flex gap-3 items-center">
                <button className="p-2 bg-amber-600 hover:text-black duration-300 border rounded-full">
                  <FaRegEdit></FaRegEdit>
                </button>
                <button
